...
public class ViewRole1Home {
	...
	private ViewRole1Home() {
		...
		// GUI Area 2
		/*
		 *  area to access posts
		 */
		
		setupButtonUI(button_ViewPost, "Dialog", 20, 200, Pos.CENTER, 275, 275);
		button_ViewPost.setOnAction((event) -> {ControllerRole1Home.performViewPost(); });
